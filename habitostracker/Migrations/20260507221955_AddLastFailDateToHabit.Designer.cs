...
namespace habitostracker.Migrations
{
    ...
    [Migration("20260507221955_AddLastFailDateToHabit")]
    partial class AddLastFailDateToHabit
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HabitTrackerApp.Models.Group", b =>
                {
                    ...
                    b.Property<string>("HealthWarningMessage")
                        .HasColumnType("longtext");
            ...
            modelBuilder.Entity("HabitTrackerApp.Models.GroupMessageReaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HabitTrackerApp.Models.Habit", b =>
                {
                    ...
                    b.Property<DateTime?>("LastFailDate")
                        .HasColumnType("datetime(6)");
            ...
            modelBuilder.Entity("HabitTrackerApp.Models.HabitProgress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HabitTrackerApp.Models.HabitProgressComment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("HabitProgressId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("HabitProgressId");

                    b.HasIndex("UserId");

                    b.ToTable("HabitProgressComments");
                });

            modelBuilder.Entity("HabitTrackerApp.Models.HabitProgressReaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("HabitProgressReactions");
                });
            ...
            modelBuilder.Entity("HabitTrackerApp.Models.MessageRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HabitTrackerApp.Models.Post", b =>
                {
                    ...
                    b.Property<bool>("IsOfficialAnnouncement")
                        .HasColumnType("tinyint(1)");

                    b.Property<bool>("IsSensitive")
                        .HasColumnType("tinyint(1)");

                    b.Property<bool>("IsUnderWarning")
                        .HasColumnType("tinyint(1)");

                    b.Property<bool>("IsWarningPost")
                        .HasColumnType("tinyint(1)");

                    b.Property<bool>("IsWelcomePost")
                        .HasColumnType("tinyint(1)");
            ...
            modelBuilder.Entity("HabitTrackerApp.Models.Repost", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HabitTrackerApp.Models.StoryLike", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HabitTrackerApp.Models.StoryView", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HabitTrackerApp.Models.User", b =>
                {
                    ...
                    b.Property<bool>("HasWelcomePost")
                        .HasColumnType("tinyint(1)");
            ...
            modelBuilder.Entity("HabitTrackerApp.Models.HabitProgressComment", b =>
                {
                    b.HasOne("HabitTrackerApp.Models.HabitProgress", "HabitProgress")
                        .WithMany("Comments")
                        .HasForeignKey("HabitProgressId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("HabitTrackerApp.Models.Message", b =>
                {
                    ...
                    b.HasOne("HabitTrackerApp.Models.Message", "ReplyToMessage")
                        .WithMany()
                        .HasForeignKey("ReplyToMessageId");
            ...
            modelBuilder.Entity("HabitTrackerApp.Models.StoryLike", b =>
                {
                    b.HasOne("HabitTrackerApp.Models.Story", "Story")
                        .WithMany("Likes")
            ...
            modelBuilder.Entity("HabitTrackerApp.Models.StoryView", b =>
                {
                    ...
                    b.HasOne("HabitTrackerApp.Models.User", "Viewer")
                        .WithMany()
